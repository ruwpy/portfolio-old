import { AnimatePresence, motion as m, useIsPresent, useSpring, useScroll } from "framer-motion";
...
export default function Projects() {
  ...
  return (
    <>
      <AnimatePresence>
        <Navbar />
        <m.main key="projects-page" animate="animate" initial="initial" className="main primary">
          <div className="projects container">
            <div className="projects__list">
              {projectsData.map((project: ProjectProps) => {
                const { barCode, brailleName, endYear, image, name, qrCode, codeLink, demoLink } =
                  project;
                return (
                  <Project
                    barCode={barCode}
