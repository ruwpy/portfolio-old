...
export default function Landing() {
  ...
  return (
    <>
      <AnimatePresence>
        <Navbar />
        <m.main key="landing-page" animate="animate" initial="initial" className="main primary">
          <div className="landing container">
            <div className="hero">
              <h1 className="hero__greating text-outline--light">
                {greetingAnimated.map((word, index) => {
                  return (
                    <m.span custom={index + 2} variants={appearAnimation} key={index}>
              ...
              <m.p variants={appearAnimation} custom={5} className="hero__introduction">
                a <span className="hl">creative frontend developer</span> who <br /> loves building{" "}
                <br /> amazing websites
              </m.p>
